...
--
-- Host: localhost
-- Generation Time: Jul 14, 2020 at 11:11 AM
...
CREATE TABLE IF NOT EXISTS blogs (
  ...
  updated_at timestamp NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY blogs_b_name_unique (b_name),
  KEY blogs_b_slug_index (b_slug),
  KEY blogs_b_active_index (b_active),
  KEY blogs_b_author_id_index (b_author_id)
...
CREATE TABLE IF NOT EXISTS categories (
  ...
  KEY categories_cate_slug_index (cate_slug)
...
CREATE TABLE IF NOT EXISTS colors (
  ...
  updated_at timestamp NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY colors_name_color_unique (name_color)
...
(83, 108, 2, 1, '95.00', 0, 'Stripe', '2020-07-12 15:55:37', '2020-07-12 15:55:37', '13', '7'),
(84, 113, 39, 1, '64.80', 0, 'COD', NULL, NULL, '13', '9'),
(85, 114, 39, 1, '64.80', 0, 'COD', NULL, NULL, '13', '9'),
(86, 116, 42, 1, '62.70', 0, 'COD', NULL, NULL, '3', '12'),
(87, 117, 38, 1, '60.30', 0, 'COD', NULL, NULL, '13', '8'),
(88, 118, 41, 1, '57.00', 0, 'Stripe', '2020-07-14 07:15:20', '2020-07-14 07:15:20', '3', '12');
...
CREATE TABLE IF NOT EXISTS products (
  ...
  KEY products_id_brand_foreign (brands_id),
...
(3, 'Shirt in Stretch Cotton', '3', '[\"12\"]', '{\"3\":\"10\",\"4\":\"10\",\"5\":\"10\",\"7\":\"10\",\"8\":\"10\",\"9\":\"10\",\"10\":\"10\",\"11\":\"10\",\"12\":\"10\",\"13\":\"15\"}', 7, 80, 105, '<p>&middot; Beautiful details in this elegant feminine blouse. Ruffled collar &amp; neckline is so gorgeous and flattering! &nbsp;</p>\r\n\r\n<p>&middot; Features:<br />\r\n&nbsp; &nbsp; - <em>Rounded buttons at cuff &amp; front</em><br />\r\n&nbsp; &nbsp; - <em>Semi-sheer</em></p>\r\n\r\n<p>&middot; I imagine this tucked into a straight leg pant or pencil skirt - but can be worn so many ways as it is incredibly versatile.</p>\r\n\r\n<p>&middot; Approx measurements:<br />\r\n&middot; Pit to pit 18.5&quot;<br />\r\n&middot; Shoulder to cuff 23.5 &quot;<br />\r\n&middot; Length 23.5&quot;</p>\r\n\r\n<p>&middot; This is in excellent condition - with one tiny pull. Please see last photo. Only seen in certain lights and&nbsp;not noticeable when worn.</p>', '[\"product-07.jpg\"]', '0', 1, 0, '2019-08-11 03:46:36', '2020-07-14 04:16:11', 'shirt-in-stretch-cotton'),
...
(39, 'Air Ghost Racer', '5', '[\"9\"]', '{\"2\":\"10\",\"3\":\"10\",\"4\":\"10\",\"5\":\"10\",\"7\":\"10\",\"8\":\"10\",\"9\":\"10\",\"10\":\"10\",\"11\":\"10\",\"12\":\"10\"}', 2, 72, 99, '<p>&middot; Beautiful details in this elegant feminine blouse. Ruffled collar &amp; neckline is so gorgeous and flattering! &nbsp;</p>\r\n\r\n<p>&middot; Features:<br />\r\n&nbsp; &nbsp; - <em>Rounded buttons at cuff &amp; front</em><br />\r\n&nbsp; &nbsp; - <em>Semi-sheer</em></p>\r\n\r\n<p>&middot; I imagine this tucked into a straight leg pant or pencil skirt - but can be worn so many ways as it is incredibly versatile.</p>\r\n\r\n<p>&middot; Approx measurements:<br />\r\n&middot; Pit to pit 18.5&quot;<br />\r\n&middot; Shoulder to cuff 23.5 &quot;<br />\r\n&middot; Length 23.5&quot;</p>\r\n\r\n<p>&middot; This is in excellent condition - with one tiny pull. Please see last photo. Only seen in certain lights and&nbsp;not noticeable when worn.</p>', '[\"air-ghost-racer-shoe-CClwQd.jpg\"]', '10', 1, 0, '2020-06-19 02:27:10', '2020-07-12 17:05:30', 'air-ghost-racer'),
...
(124, 3, 13, 12, 15, '2020-06-16 03:28:12', '2020-07-14 04:15:02'),
...
(184, 39, 13, 9, 9, '2020-06-19 02:27:10', '2020-07-12 17:05:30'),
...
(354, 57, 3, 9, 11, '2020-07-06 16:43:23', '2020-07-14 04:44:11'),
...
(358, 57, 8, 9, 15, '2020-07-06 16:43:23', '2020-07-14 07:18:07'),
...
CREATE TABLE IF NOT EXISTS sizes (
  ...
  updated_at timestamp NULL DEFAULT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY sizes_letter_size_unique (letter_size)
...
(100, 12, '77.000', NULL, 'Hà Nội', '0964387230', 0, '2020-07-06 05:34:30', '2020-07-13 08:01:09', 'COD', 3),
...
(108, 12, '115.000', NULL, 'Hà Nội', '0964387230', 0, '2020-07-12 15:55:17', NULL, 'Stripe', 0),
(113, 12, '84.800', NULL, 'Hà Nội', '0964387230', 1, '2020-07-12 17:05:04', '2020-07-12 17:05:30', 'COD', 0),
(114, 12, '84.800', NULL, 'Hà Nội', '0964387230', 0, '2020-07-13 08:00:08', '2020-07-13 08:00:08', 'COD', 0),
(116, 12, '82.700', NULL, 'Hà Nội', '0964387230', 0, '2020-07-13 08:05:37', '2020-07-13 08:05:37', 'COD', 0),
(117, 12, '80.300', NULL, 'Hà Nội', '0964387230', 0, '2020-07-14 04:14:06', '2020-07-14 04:14:06', 'COD', 0),
(118, 18, '77.000', NULL, 'Hà Nội', '0964387230', 0, '2020-07-14 07:11:43', '2020-07-14 07:11:43', 'Stripe', 0);
...
(12, 'Đỗ Mạnh Hùng', 'domanhhung812@gmail.com', NULL, 'd1880e529f94b1fc87266202e46c2854', '0964387230', 'Hà Nội', 'jA3aA304cT3TwoHTRXvfEyrzKzHxMNGHUAvdjVwJPPKIHh2ZeZs7goYthCc0', '2020-03-14 12:50:11', '2020-06-22 02:47:13', NULL, NULL, '1592794033.jpg', '117246217030208240648', ''),
...
(18, 'Duc Hieu', 'duchieu@gmail.com', NULL, '$2y$10$v7J3Tw0fIdnkXgLEKq6kHepaHJlMQSBzi9Nvs.NNnX1aXfjr0RlNK', NULL, NULL, 'tFQwiIaONOJcmnrD4ErSJURsHL3ErAvjUh0tfXmTNWEJCjGeKwoAkGfn9R8z', '2020-07-05 05:13:34', '2020-07-05 05:13:34', NULL, NULL, NULL, NULL, NULL),
...
(21, 'Duc Hieu', 'hung.test1208@gmail.com', NULL, '$2y$10$uhO2OLYQ88/Jb1ddLdArDuCmoTjDVpVL2NkY7On1QztjwuUxdFcYm', NULL, NULL, NULL, '2020-07-13 03:36:59', '2020-07-13 03:37:17', 'c6828188a32c1dc61e181281c89d608c', '2020-07-13 10:37:17', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS user_favorite (
  ...
  updated_at timestamp NULL DEFAULT NULL,
  PRIMARY KEY (uf_id),
  UNIQUE KEY user_favorite_uf_product_id_uf_user_id_unique (uf_product_id,uf_user_id)
